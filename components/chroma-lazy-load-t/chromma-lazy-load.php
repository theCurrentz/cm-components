...
include( plugin_dir_path( __FILE__ ) . '/classes/chromma-lazy-load-module.php');
//require caption override
include( plugin_dir_path( __FILE__ ) . '/includes/caption_shortcode_override.php');
//require lazy load admin page
include( plugin_dir_path( __FILE__ ) . '/includes/chromma_lazy_load_admin_page.php');
...
include( plugin_dir_path( __FILE__ ) . '/includes/get-image-sizes.php');
