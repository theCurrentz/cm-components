...
<div id="post-cost-table-container">
  ...
  'category__not_in' => array(get_cat_ID( 'Social' )),
	));
    ...
    var_dump(get_cat_ID( 'Social' ));
		echo '<table class="post-cost-table"><tr><th>Author</th><th>Post Title</th><th>Date</th><th>Cat</th><th>Word Count</th><th>Rate</th><th>Cost</th></tr>';
